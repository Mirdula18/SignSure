...
export const hi: Dictionary = {
  ...
  'app.privacyNote':
    'आपकी फ़ाइल आपके ब्राउज़र से बाहर नहीं जाती। उसके क्लॉज़ का टेक्स्ट और आपके पूछे सवाल, समझाने के लिए SignSure के सर्वर के ज़रिए Google के Gemini API को भेजे जाते हैं; SignSure इन्हें न सेव करता है, न लॉग करता है, और इन पर Google के Gemini API की शर्तें लागू होती हैं। इस ब्राउज़र में सिर्फ़ आपकी भाषा और पढ़ने के स्तर की पसंद सेव होती है, और "सब कुछ हटाएँ" इस पेज से डॉक्यूमेंट हटा देता है।',
  'app.footerNote':
  ...
  'app.loadFailed':
    'SignSure का यह हिस्सा लोड नहीं हुआ, आमतौर पर इसलिए कि साइट अभी-अभी अपडेट हुई है। पेज दोबारा लोड करने से यह ठीक हो जाएगा। आपका डॉक्यूमेंट कहीं सेव नहीं होता, इसलिए आपको उसे फिर से जोड़ना होगा।',
  'app.reload': 'पेज दोबारा लोड करें',
  ...
  'home.trust3Title': 'आपकी फ़ाइल आपके ही डिवाइस पर रहती है',
  'home.trust3Body':
  ...
  'overview.summarySources':
    'यह सार AI ने {clauses} से तैयार किया है। भरोसा करने से पहले हर जानकारी इन शर्तों से मिलाकर देख लें।',
  'overview.summaryNoSources':
    'यह सार AI ने तैयार किया है। भरोसा करने से पहले हर जानकारी अपने डॉक्यूमेंट से मिलाकर देख लें।',
  ...
  /* -------------------------------------- risk ---------------------------------- */
  'category.NOTICE_PERIOD': 'नोटिस अवधि',
  'category.BOND_OR_EXIT_PENALTY': 'बॉन्ड या नौकरी छोड़ने पर जुर्माना',
  'category.NON_COMPETE': 'प्रतिस्पर्धी कंपनी में काम पर रोक',
  'category.NON_SOLICIT': 'ग्राहकों और सहकर्मियों से संपर्क पर रोक',
  'category.CONFIDENTIALITY': 'गोपनीयता',
  'category.IP_ASSIGNMENT': 'बौद्धिक संपदा',
  'category.COMPENSATION': 'वेतन',
  'category.PROBATION': 'प्रोबेशन',
  'category.TERMINATION': 'नौकरी समाप्ति',
  'category.WORKING_HOURS_LEAVE': 'काम के घंटे और छुट्टी',
  'category.BENEFITS': 'लाभ',
  'category.MOONLIGHTING': 'दूसरा काम',
  'category.DISPUTE_RESOLUTION': 'विवाद',
  'category.DOCUMENT_RETENTION': 'आपके डॉक्यूमेंट जमा रखना',
  ...
  'error.UNAUTHORIZED':
    'आपके सेशन को फिर से बनाना ज़रूरी था, और SignSure अभी वही कर रहा है। कृपया थोड़ी देर में दोबारा कोशिश करें। आपका डॉक्यूमेंट अभी भी यहीं है।',
  ...
  'error.BUDGET_EXHAUSTED':
    'इस विज़िट की सभी AI रिक्वेस्ट इस्तेमाल हो चुकी हैं। जो जवाब आपको मिल चुके हैं, वे काम करते रहेंगे। नई विज़िट शुरू करने के लिए पेज दोबारा लोड करें।',
  'error.MODEL_BLOCKED':
  ...
  /* --------------------------------------- session -------------------------------- */
  'session.failed':
    'SignSure इस डॉक्यूमेंट के लिए सेशन शुरू नहीं कर पाया। कृपया पेज दोबारा लोड करें।',
};
